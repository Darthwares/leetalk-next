...
Now, let's go over a more general example with a cycle. We will recreate the [`AgentExecutor`](/docs/modules/agents/concepts#agentexecutor) class from LangChain.
